...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function loadCourses() {
    ...
    const url = `https://smileschool-api.hbtn.info/courses?q=${currentSearch}&topic=${currentTopic}&sort=${currentSort}`;
    ...
    fetch(url)
      ...
      .then(data => {
        ...
        sortDropdown.innerHTML = data.sorts.map(sort => 
        ...
        // Update video cards
        resultsSection.innerHTML = data.courses.map(course => `
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="info pt-3 d-flex justify-content-between">
                  <div class="rating">
                    ${[...Array(5)].map((_, i) => 
                      `<img src="images/${i < course.star ? "star_on" : "star_off"}.png" alt="star" width="15px" />`
                    ).join("")}
                  </div>
  ...
  topicDropdown.addEventListener("click", (e) => {
    if (e.target.classList.contains("dropdown-item")) {
      ...
      e.target.closest(".dropdown").querySelector("span").textContent = e.target.textContent;
      loadCourses();
    }
  });
